...
// ! _kTabHeight height changed from 48.0
// _tabHeight - 2 from SurveyView to avoid render issues
const double _kTabHeight = 70.0;
// ! _kTextAndIconTabHeight height changed from 72.0
